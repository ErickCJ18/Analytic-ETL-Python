...
def procesar_dim_origen(repo: CleanRepository,
    ...
    df_nuevas, df_dup_bd = repo.dedup(r.df_validas, "DimOrigen", "NombreFuente")
    insertados = repo.insert(df_nuevas, "DimOrigen")

    return ResumenEntidad("DimOrigen", r.procesadas, insertados,
