...
def procesar_dim_fecha(repo: CleanRepository,
    ...
    df_nuevas, df_dup_bd = repo.dedup(r.df_validas, "DimFecha", "FullDate")
    insertados = repo.insert(df_nuevas, "DimFecha")

    return ResumenEntidad("DimFecha", r.procesadas, insertados,
