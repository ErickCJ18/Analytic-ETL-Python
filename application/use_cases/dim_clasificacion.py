...
def procesar_dim_clasificacion(repo: CleanRepository,
    ...
    df_nuevas, df_dup_bd = repo.dedup(r.df_validas, "DimClasificacion", "Clasificacion")
    insertados = repo.insert(df_nuevas, "DimClasificacion")

    return ResumenEntidad("DimClasificacion", r.procesadas, insertados,
