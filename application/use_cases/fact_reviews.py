...
def procesar_fact_reviews(repo: CleanRepository,
    ...
    df_nuevas, df_dup_bd = repo.dedup(r_keys.df_validas, "FactReviews",
                                      ["ClienteKey", "ProductoKey", "FechaKey"])
    insertados = repo.insert(df_nuevas, "FactReviews")

    return ResumenEntidad("FactReviews", r.procesadas, insertados,
